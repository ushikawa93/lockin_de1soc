...
if(medir_de1soc):
    ...
    data=de1soc_handler.leer_archivo_barrido(file_path, corregir)
...
medir_sr865 = False;
nombre_archivo_sr865 = "r10k_c1n_sr865.dat"
directorio_sr865 = "../datos_adquiridos/r10kc1n"
file_path_sr865 = os.path.join(directorio_sr865,nombre_archivo_sr865)

if(medir_sr865):
    # Datos para el barrido en frecuencia
    f_start = 10; f_stop = 40000; step = 10;
