...
wire [31:0] M;	assign M = ptos_x_ciclo;				// Puntos por ciclo de se̱al
wire [31:0] N; 	assign N = frames_integracion;		// Frames de integracion // Largo del lockin M*N	

reg [63:0] acumulador;

reg [31:0] n_datos_promediados_reg;
...
begin
	...
	begin
		...
		begin
			...
			n_datos_promediados_reg <= n_datos_promediados_reg + 1;
		end
...
assign n_datos_promediados = n_datos_promediados_reg;
