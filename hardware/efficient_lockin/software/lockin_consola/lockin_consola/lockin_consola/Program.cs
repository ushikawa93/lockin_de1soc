...
namespace lockin_consola
{
    internal class Program
    {
        ...
        static bool corregir_resultado = true;
        ...
        static void CambiarConfiguracion()
        {
            ...
            try
            {
                string opcional = ((int)fuente == 2) ? "(9 para modificar bits de ruido)" : "";
                ...
                switch (num)
                {
                    ...
                    case 3:
                        Console.Write("Nuevo valor para N (CALI): ");
        ...
        {
            Console.Clear();
            Console.WriteLine($"Ingrese: \n1: {menues.mode(FPGA.PROC_MODE.CALI,N_ca_CALI,N_LI)} \n2: {menues.mode(FPGA.PROC_MODE.LI,N_ca_CALI,N_LI)} \n3: Ambos procesamientos en simultaneo \n0: Volver al menu principal");
        ...
        static void Barrido_y_comparacion()
        {
            ...
            writer_cali.WriteLine($"Metodo usado: {menues.mode(FPGA.PROC_MODE.CALI,N_ca_CALI,N_LI)}");
            ...
            writer_li.WriteLine($"Metodo usado: {menues.mode(FPGA.PROC_MODE.LI, N_ca_CALI, N_LI)}");
